...
// We define a new array, with elements (here, possible LookUpTable) separated by commas.
...
// There is other functions that you can use with the array (cf. https://imagej.net/ij/macros/functions)
...
// that make use of array functions
